...
:experimental:
:url-github: https://github.com/hyperpolymath/git-rsr-certified
:url-gitlab: https://gitlab.com/hyperpolymath/git-rsr-certified
:url-bitbucket: https://bitbucket.org/hyperpolymath/git-rsr-certified
:url-codeberg: https://codeberg.org/hyperpolymath/git-rsr-certified

RSR certification badge and compliance checker
...
git-rsr-certified is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
